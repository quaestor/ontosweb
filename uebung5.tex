...
Nach Anwendung von Umformungsregeln für Implikation, Diamond, De Morgan'schen
Regeln, ($\wedge$)-Regeln auf oberster Ebene und Anwendung der ($\neg\neg$)
Regel des Kalküls wird die Formel wie folgt dargestellt. Anschließend werden die
